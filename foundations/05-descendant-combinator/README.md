...
The goal of this exercise is to apply styles to elements that are descendants of anoautother element, while leaving elements that *aren't* descendants of that element unstyled.
